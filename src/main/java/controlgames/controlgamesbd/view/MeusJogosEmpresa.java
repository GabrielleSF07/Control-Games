...
public class MeusJogosEmpresa extends javax.swing.JFrame {
    ...
    public MeusJogosEmpresa(Desenvolvedores d) {
       initComponents();
    ...
    if (jogos != null && !jogos.isEmpty() && indexAtual >= 0 && indexAtual < jogos.size()) {
        ...
        txtValor.setText(String.valueOf(jogoAtual.getValor()));
        txtDescricao.setText(jogoAtual.getDescricao());
        txtCategoria.setText(jogoAtual.getCategoria());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MeusJogosEmpresa(d).setVisible(true);
            }
        });
    }
