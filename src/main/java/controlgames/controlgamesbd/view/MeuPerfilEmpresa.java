...
public class MeuPerfilEmpresa extends javax.swing.JFrame {
    ...
    private void carregarPerfil() {
        ...
        if (dados != null) {
            ...
            txtQntdeJogos.setText(String.valueOf(dados[2]));
            txtTotalVendido.setText(String.valueOf(dados[3] != null ? dados[3] : 0));
            txtLucro.setText(String.format("R$ %.2f", dados[4] != null ? dados[4] : 0.0));
        }
    }
